    ...
    <nav class="navbar navbar-expand-lg  navbar-light">
      <div class="container">
        <a class="navbar-brand" href="index.html">
          <img src="img/logo3.png" alt="" width="50" hieght="50"/>
        </a>
    ...
    <div class="container">
      <div class="row justify-content-center fullscreen align-items-center">
        <div class="col-lg-5 col-md-8 home-banner-left">
          <h2 class="text-white">
          <font size="+3"> Provably Secure Key-Aggregate Crypto systems with Broadcast Aggregate Keys for Online Data Sharing </font>
           <br />
           
          </h2>
         <h6> <p class="mx-auto text-white  mt-20 mb-40">
             </p></h6>
        </div>
...
<br>
      ...
      <div class="one_half">
        <ul class="nospace group">
         ...
         <img src="images/demo/backgrounds/Figure1.png" alt="" />
      </div>
    </div>
</div>
